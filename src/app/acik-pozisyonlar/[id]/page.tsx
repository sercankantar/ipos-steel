...
// Statik iş ilanları (açık pozisyonlar sayfasıyla aynı)
const jobListings = [
  {
    id: 1,
    ...
    responsibilities: [
      'Güneş enerjisi sistemleri için elektrik projelerinin tasarımı',
      'Kablo tava sistemlerinin teknik çözümlerinin geliştirilmesi',
      'Proje ekibi ile koordinasyon ve teknik destek sağlama',
      'Müşteri ihtiyaçlarına uygun özel çözümler üretme',
      'Teknik dokümantasyon hazırlama ve güncelleme'
    ],
    qualifications: [
      'Elektrik Mühendisliği lisans mezunu',
      'En az 2 yıl elektrik sistem tasarımı deneyimi',
      'AutoCAD Electrical, ETAP veya benzer yazılım bilgisi',
      'Güneş enerjisi ve elektrik altyapı sistemleri konusunda bilgi',
      'İngilizce orta seviye (yazılı ve sözlü)',
      'Takım çalışmasına yatkın, analitik düşünme yetisi',
      'Saha çalışmalarına uygunluk'
    ],
    benefits: [
      'Rekabetçi maaş paketi',
      'Sağlık sigortası (çalışan + aile)',
      'Yemek kartı',
      'Ulaşım desteği',
      'Eğitim ve gelişim fırsatları',
      'Performans primi',
      'Yıllık izin + ek izin günleri'
    ],
    featured: true,
    salary: '25.000 - 35.000 TL',
    workingHours: '08:30 - 17:30',
    reportingTo: 'Proje Müdürü'
  },
  {
    id: 2,
    ...
    responsibilities: [
      'Üretim planlarının hazırlanması ve takibi',
      'Stok yönetimi ve malzeme planlaması',
      'Üretim süreçlerinin optimizasyonu',
      'Departmanlar arası koordinasyon',
      'Raporlama ve analiz çalışmaları'
    ],
    qualifications: [
      'Endüstri Mühendisliği lisans mezunu',
      'En az 3 yıl üretim planlama deneyimi',
      'ERP sistemleri (SAP, Oracle vb.) deneyimi',
      'Excel ileri seviye, Power BI bilgisi artı',
      'Analitik düşünme ve problem çözme yetisi',
      'İletişim becerileri güçlü',
      'Vardiya sistemine uygunluk'
    ],
    benefits: [
      'Rekabetçi maaş paketi',
      'Sağlık sigortası',
  ...
  },
  {
    ...
    responsibilities: [
      'Müşteri portföyü yönetimi ve geliştirilmesi',
      'Satış hedeflerinin gerçekleştirilmesi',
      'Teknik ürün sunumları ve demonstrasyonları',
      'Müşteri ihtiyaç analizi ve çözüm önerileri',
      'Satış sonrası destek ve takip'
    ],
    qualifications: [
      'Üniversite mezunu (tercihen Mühendislik)',
      'En az 1 yıl B2B satış deneyimi',
      'Elektrik/elektronik sektörü deneyimi artı',
      'Güçlü iletişim ve sunum becerileri',
      'B sınıfı sürücü belgesi',
      'Saha çalışmalarına uygunluk',
      'CRM sistemleri bilgisi artı'
    ],
    benefits: [
    ...
    featured: false,
    salary: '18.000 - 25.000 TL + Komisyon',
    workingHours: 'Esnek çalışma saatleri',
    reportingTo: 'Satış Müdürü'
  },
  {
    id: 4,
    ...
    responsibilities: [
      ...
      'Üretim süreçlerinde kalite takibi',
      'Test ve ölçüm işlemlerinin yürütülmesi',
      'Kalite raporlarının hazırlanması',
      'İyileştirme projelerine katılım'
    ],
    qualifications: [
      'Makine/Elektrik Mühendisliği mezunu',
      'En az 2 yıl kalite kontrol deneyimi',
      'ISO 9001, ISO 14001 standartları bilgisi',
      'Ölçüm cihazları kullanım deneyimi',
      'Detay odaklı ve titiz çalışma',
      'Raporlama ve dokümantasyon becerileri',
          ...
          <div className='text-white'>
            ...
            <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-6'>
              <div>
                ...
                <p className='text-xl text-blue-400 font-medium'>{job.department}</p>
              </div>
        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50'>
          <div className='bg-white rounded-lg max-w-md w-full p-6'>
            ...
            <div className='flex gap-3'>
              ...
              <a 
                href='mailto:kariyer@ipossteel.com?subject=Başvuru: Elektrik Mühendisi&body=Merhaba, Elektrik Mühendisi pozisyonu için başvuru yapmak istiyorum.'
