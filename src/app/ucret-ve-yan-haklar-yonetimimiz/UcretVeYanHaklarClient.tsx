...
export default function UcretVeYanHaklarClient() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('/api/salary-and-benefits')
    ...
    return (
      <div className='min-h-screen bg-white flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-gray-600'>Ücret ve yan haklar bilgileri yüklenemedi.</p>
        </div>
      </div>
    )
  }
        ...
        <div className='py-16'>
          ...
          <section className='mb-16'>
            <div className='text-center mb-12'>
              <h2 className='text-3xl font-bold text-gray-900 mb-4'>{data.salaryPolicyTitle}</h2>
            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div className='space-y-6'>
                <div className='bg-blue-50 p-6 border-l-4 border-blue-600'>
                  <h3 className='text-xl font-bold text-gray-900 mb-3'>{data.salaryPolicySubtitle}</h3>
                  <p className='text-gray-700 leading-relaxed'>
                    {data.salaryPolicyContent}
                  </p>
                </div>

                <div className='bg-gray-50 p-6 border border-gray-200'>
                  <h3 className='text-xl font-bold text-gray-900 mb-4'>{data.strategyTitle}</h3>
                  ...
                  <div className='space-y-3'>
                    ...
                    <ul className='space-y-2'>
                      {data.strategyBullets.map((bullet, index) => (
              ...
              <div className='relative'>
                <img 
                  src={data.salaryPolicyImageUrl || 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&h=400&fit=crop&crop=center'}
          ...
          <section className='mb-16'>
            <div className='text-center mb-12'>
              <h2 className='text-3xl font-bold text-gray-900 mb-4'>{data.benefitsTitle}</h2>
                ...
                <div className='bg-gray-800 text-white px-6 py-6'>
                  <div className='flex items-center gap-3 mb-2'>
                    ...
                    <h3 className='text-xl font-bold'>
                      {data.generalBenefitsTitle}
                    </h3>
                  </div>
                  <p className='text-gray-300 text-sm leading-relaxed'>
                    {data.generalBenefitsSubtitle}
                  </p>
                </div>
                ...
                <div className='p-6'>
                  <ul className='space-y-4'>
                    {data.generalBenefits.map((benefit, index) => (
                      <li key={index} className='p-4 bg-gray-50 border-l-4 border-blue-600'>
              ...
              <div className='bg-white border border-gray-200 shadow-lg'>
                <div className='bg-gray-700 text-white px-6 py-6'>
                  <div className='flex items-center gap-3 mb-2'>
                    ...
                    <h3 className='text-xl font-bold'>
                      {data.positionBenefitsTitle}
                    </h3>
                  </div>
                  <p className='text-gray-300 text-sm leading-relaxed'>
                    {data.positionBenefitsSubtitle}
                  </p>
                </div>
                
                <div className='p-6'>
                  <ul className='space-y-4'>
                    {data.positionBenefits.map((benefit, index) => (
                      <li key={index} className='p-4 bg-gray-50 border-l-4 border-orange-600'>
                        <h4 className='font-semibold text-gray-900 mb-2'>{benefit.title}</h4>
                        <p className='text-sm text-gray-700 leading-relaxed'>
                          {benefit.description}
                        </p>
